...
namespace BlackHole.ExecutionProviders
{
    internal class SqlServerExecutionProvider : IExecutionProvider
    {
        ...
        internal SqlServerExecutionProvider(string connectionString, bool forceQuotes)
        {
        ...
        public bool JustExecute(string commandText, List<BlackHoleParameter>? parameters)
        {
            ...
            {
                Task.Factory.StartNew(() => _loggerService.CreateErrorLogs("NonQuery", commandText, ex.Message, ex.ToString()));
                return false;
            }
        }
        ...
        public async Task<bool> JustExecuteAsync(string commandText, List<BlackHoleParameter>? parameters)
        {
            ...
            {
                await Task.Factory.StartNew(() => _loggerService.CreateErrorLogs("NonQueryAsync", commandText, ex.Message, ex.ToString()));
                return false;
            }
        }
