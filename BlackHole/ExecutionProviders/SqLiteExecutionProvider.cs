...
namespace BlackHole.ExecutionProviders
{
    internal class SqLiteExecutionProvider : IExecutionProvider
    {
        ...
        internal SqLiteExecutionProvider(string connectionString, bool forceQuotes)
        {
        ...
        public G? ExecuteScalar<G>(string commandText, List<BlackHoleParameter>? parameters)
        {
            ...
            {
                Task.Factory.StartNew(() => _loggerService.CreateErrorLogs("Scalar", commandText, ex.Message, ex.ToString()));
                return default;
            }
        }
        ...
        public async Task<G?> ExecuteScalarAsync<G>(string commandText, List<BlackHoleParameter>? parameters)
        {
            ...
            {
                await Task.Factory.StartNew(() => _loggerService.CreateErrorLogs("ScalarAsync", commandText, ex.Message, ex.ToString()));
                return default;
            }
        }
        ...
        public object? ExecuteRawScalar(string commandText, List<BlackHoleParameter>? parameters)
        {
            ...
            {
                Task.Factory.StartNew(() => _loggerService.CreateErrorLogs("RawScalar", commandText, ex.Message, ex.ToString()));
                return default;
            }
        }
        ...
        public async Task<object?> ExecuteRawScalarAsync(string commandText, List<BlackHoleParameter>? parameters)
        {
            ...
            {
                await Task.Factory.StartNew(() => _loggerService.CreateErrorLogs("RawScalarAsync", commandText, ex.Message, ex.ToString()));
                return default;
            }
        }
        ...
        public bool JustExecute(string commandText, List<BlackHoleParameter>? parameters)
        {
            ...
            {
                Task.Factory.StartNew(() => _loggerService.CreateErrorLogs("NonQuery", commandText, ex.Message, ex.ToString())).Start();
                return false;
            }
        }
        ...
        public async Task<bool> JustExecuteAsync(string commandText, List<BlackHoleParameter>? parameters)
        {
            ...
            {
                Task.Factory.StartNew(() => _loggerService.CreateErrorLogs("NonQueryAsync", commandText, ex.Message, ex.ToString())).Start();
                return false;
            }
        }
        ...
        public T? QueryFirst<T>(string commandText, List<BlackHoleParameter>? parameters)
        {
            ...
            {
                Task.Factory.StartNew(() => _loggerService.CreateErrorLogs($"QueryFirst_{typeof(T).Name}", commandText, ex.Message, ex.ToString()));
                return default;
            }
        }
        ...
        public List<T> Query<T>(string commandText, List<BlackHoleParameter>? parameters)
        {
            ...
            {
                Task.Factory.StartNew(() => _loggerService.CreateErrorLogs($"Query_{typeof(T).Name}", commandText, ex.Message, ex.ToString()));
                return new List<T>();
            }
        }
        ...
        public async Task<T?> QueryFirstAsync<T>(string commandText, List<BlackHoleParameter>? parameters)
        {
            ...
            {
                await Task.Factory.StartNew(() => _loggerService.CreateErrorLogs($"QueryFirstAsync_{typeof(T).Name}", commandText, ex.Message, ex.ToString()));
                return default;
            }
        }
        ...
        public async Task<List<T>> QueryAsync<T>(string commandText, List<BlackHoleParameter>? parameters)
        {
            ...
            {
                await Task.Factory.StartNew(() => _loggerService.CreateErrorLogs($"QueryAsync_{typeof(T).Name}", commandText, ex.Message, ex.ToString()));
                return new List<T>();
            }
        }
