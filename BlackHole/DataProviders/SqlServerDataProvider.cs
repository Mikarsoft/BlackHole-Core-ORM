...
namespace BlackHole.DataProviders
{
    internal class SqlServerDataProvider : IDataProvider
    {
        ...
        public T? QueryFirst<T>(string commandText, List<BlackHoleParameter>? parameters)
        {
            ...
            {
                new Thread(() => _loggerService.CreateErrorLogs($"SelectFirst_{TableName}", ex.Message, ex.ToString())).Start();
                return default(T);
            }
        }
        ...
        public List<T> Query<T>(string command, List<BlackHoleParameter>? parameters)
        {
            ...
            {
                new Thread(() => _loggerService.CreateErrorLogs($"Select_{TableName}", ex.Message, ex.ToString())).Start();
                return new List<T>();
            }
        }
        ...
        public async Task<T?> QueryFirstAsync<T>(string command, List<BlackHoleParameter>? parameters)
        {
            ...
            {
                new Thread(() => _loggerService.CreateErrorLogs($"SelectFirstAsync_{TableName}", ex.Message, ex.ToString())).Start();
                return default(T);
            }
        }
        ...
        public async Task<List<T>> QueryAsync<T>(string command, List<BlackHoleParameter>? parameters)
        {
            ...
            {
                new Thread(() => _loggerService.CreateErrorLogs($"SelectAsync_{TableName}", ex.Message, ex.ToString())).Start();
                return new List<T>();
            }
        }
