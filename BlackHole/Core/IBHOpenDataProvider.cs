...
namespace BlackHole.Core
{
    ...
    public interface IBHOpenDataProvider<T> where T :BHOpenEntity<T>
    {
        ...
        /// <typeparam name="Dto">Data Transfer Object</typeparam>
        /// <returns>All Active Entities of the Table mapped to DTO</returns>
        List<Dto> GetAllEntries<Dto>(Action<BHOrderBy<T>> orderBy, BHTransaction transaction) where Dto : BHOpenDto;
        ...
        /// <param name="transaction">Transaction Object</param>
        /// <returns>Data Transfer Object</returns>
        Dto? GetEntryWhere<Dto>(Expression<Func<T, bool>> predicate, BHTransaction transaction) where Dto : BHOpenDto;
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        Dto? GetEntryWhere<Dto>(Expression<Func<T, bool>> predicate, Action<BHOrderBy<T>> orderBy, BHTransaction transaction) where Dto : BHOpenDto;
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        List<Dto> GetEntriesWhere<Dto>(Expression<Func<T, bool>> predicate, Action<BHOrderBy<T>> orderBy, BHTransaction transaction) where Dto : BHOpenDto;
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        Task<List<Dto>> GetAllEntriesAsync<Dto>(Action<BHOrderBy<T>> orderBy, BHTransaction transaction) where Dto : BHOpenDto;
        ...
        /// <param name="transaction">Transaction Object</param>
        /// <returns>Data Transfer Object</returns>
        Task<Dto?> GetEntryAsyncWhere<Dto>(Expression<Func<T, bool>> predicate, BHTransaction transaction) where Dto : BHOpenDto;
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        Task<Dto?> GetEntryAsyncWhere<Dto>(Expression<Func<T, bool>> predicate, Action<BHOrderBy<T>> orderBy, BHTransaction transaction) where Dto : BHOpenDto;
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        Task<List<Dto>> GetEntriesAsyncWhere<Dto>(Expression<Func<T, bool>> predicate, Action<BHOrderBy<T>> orderBy, BHTransaction transaction) where Dto : BHOpenDto;
