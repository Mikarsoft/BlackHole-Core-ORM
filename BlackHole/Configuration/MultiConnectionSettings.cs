...
namespace BlackHole.Configuration
{
    ...
    internal class MultiConnectionSettings
    {
        ...
        /// <param name="connectionString">connection string to the database</param>
        /// <returns>Additional Settings</returns>
        public ConnectionAdditionalSettings UseSqlServer(string connectionString, DatabaseRole dbRole)
        {
            ConnectionString = connectionString;
            ConnectionType = BlackHoleSqlTypes.SqlServer;
            return additionalSettings;
        ...
        /// <param name="quotedDb">Use quotes for Naming</param>
        /// <returns>Additional Settings</returns>
        public ConnectionAdditionalSettings UseSqlServer(string connectionString, DatabaseRole dbRole, bool quotedDb)
        {
            ConnectionString = connectionString;
            ConnectionType = BlackHoleSqlTypes.SqlServer;
            UseQuotedDb = quotedDb;
        ...
        /// <param name="connectionString">connection string to the database</param>
        /// <returns>Additional Settings</returns>
        public ConnectionAdditionalSettings UseNpgSql(string connectionString, DatabaseRole dbRole)
        {
            ConnectionString = connectionString;
            ConnectionType = BlackHoleSqlTypes.Postgres;
            return additionalSettings;
        ...
        /// <param name="connectionString">connection string to the database</param>
        /// <returns>Additional Settings</returns>
        public ConnectionAdditionalSettings UseMySql(string connectionString, DatabaseRole dbRole)
        {
            ConnectionString = connectionString;
            ConnectionType = BlackHoleSqlTypes.MySql;
            return additionalSettings;
        ...
        /// <param name="databaseName">Just the name of the database</param>
        /// <returns>Additional Settings</returns>
        public ConnectionAdditionalSettings UseSqlite(string databaseName, DatabaseRole dbRole)
        {
            ConnectionString = databaseName;
            ConnectionType = BlackHoleSqlTypes.SqlLite;
            return additionalSettings;
        ...
        /// <param name="quotedDb">Use quotes for Naming</param>
        /// <returns>Additional Settings</returns>
        public ConnectionAdditionalSettings UseSqlite(string databaseName, DatabaseRole dbRole, bool quotedDb)
        {
            ConnectionString = databaseName;
            ConnectionType = BlackHoleSqlTypes.SqlLite;
            UseQuotedDb = quotedDb;
        ...
        /// <param name="connectionString">connection string to the database</param>
        /// <returns>Additional Settings</returns>
        public ConnectionAdditionalSettings UseOracle(string connectionString, DatabaseRole dbRole)
        {
            ConnectionString = connectionString;
            ConnectionType = BlackHoleSqlTypes.Oracle;
            return additionalSettings;
