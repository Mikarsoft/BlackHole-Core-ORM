...
namespace BlackHole.Configuration.ConfigTypes
{
    ...
    /// 
    /// </summary>
    public class OracleDbConfig : BHDatabaseConfig
    {
        internal OracleDbConfig(bool useQuotedDb, int connectionTimeout) : base(useQuotedDb, connectionTimeout, BlackHoleSqlTypes.Oracle)
        {
        }
