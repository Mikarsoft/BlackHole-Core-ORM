...
namespace BlackHole.Configuration.ConfigTypes
{
    ...
    /// 
    /// </summary>
    public class SqLiteConfig : BHDatabaseConfig
    {
        internal SqLiteConfig(bool useQuotedDb, int connectionTimeout) : base(useQuotedDb, connectionTimeout, BlackHoleSqlTypes.SqlLite)
        {
        }
