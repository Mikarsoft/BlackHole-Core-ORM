...
namespace BlackHole.RayCore
{
    sealed internal class DbSchemaInfo
    {
        ...
        internal Type? _type;
        internal Ray64.SQL_TYPE? _dbtype;
        ...
        internal Ray64.SQL_C _sqlctype;         // need this to bind the value
        internal Ray64.SQL_TYPE _sql_type;      // need that to properly marshal the value
    }
    ...
    sealed internal class DbCache
    {
        ...
        private RayDataReader _record;
        internal int _count;
        internal bool _randomaccess = true;

        //Constructor
        internal DbCache(RayDataReader record, int count)
        {
            _count = count;
            _record = record;
