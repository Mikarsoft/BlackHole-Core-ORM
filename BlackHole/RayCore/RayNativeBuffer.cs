...
{
    internal class RayNativeBuffer : SafeHandle
    {
        ...
        private RayNativeBuffer(int initialSize, bool zeroBuffer) : base(IntPtr.Zero, true)
        {
            if (0 < initialSize)
            {
        ...
        protected RayNativeBuffer(int initialSize) : this(initialSize, true)
        {
        }

        protected RayNativeBuffer(IntPtr invalidHandleValue, bool ownsHandle) : base(invalidHandleValue, ownsHandle)
        {
        }
