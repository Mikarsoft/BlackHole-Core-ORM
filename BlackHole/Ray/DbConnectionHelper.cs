...
namespace BlackHole.Ray
{
    ...
    public abstract class CONNECTIONOBJECTNAME : DbConnection
    {
        ...
        internal void EnlistDistributedTransactionHelper(System.EnterpriseServices.ITransaction transaction)
        {
