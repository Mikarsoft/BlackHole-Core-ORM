...
namespace BlackHole.Ray
{
    sealed internal class CNativeBuffer : System.Data.ProviderBase.DbBuffer
    {
        ...
        internal object MarshalToManaged(int offset, Ray32.SQL_C sqlctype, int cb)
        {
            object value;
            switch (sqlctype)
            {
                ...
                case Ray32.SQL_C.SSHORT:
                    value = ReadInt16(offset);
                    break;

                case Ray32.SQL_C.SLONG:
                    value = ReadInt32(offset);
                    break;

                case Ray32.SQL_C.SBIGINT:
                    value = ReadInt64(offset);
                    break;

                case Ray32.SQL_C.BIT:
                    Byte b = ReadByte(offset);
                    value = (b != 0x00);
                    break;

                case Ray32.SQL_C.REAL:
                    value = ReadSingle(offset);
                    break;

                case Ray32.SQL_C.DOUBLE:
                    value = ReadDouble(offset);
                    break;

                case Ray32.SQL_C.UTINYINT:
                    value = ReadByte(offset);
                    break;

                case Ray32.SQL_C.GUID:
                    value = ReadGuid(offset);
                    break;

                case Ray32.SQL_C.TYPE_TIMESTAMP:
                ...
                case Ray32.SQL_C.NUMERIC:
                    //Note: Unfortunatly the Ray NUMERIC structure and the URT DECIMAL structure do not
        ...
        //
        internal void MarshalToNative(int offset, object value, Ray32.SQL_C sqlctype, int sizeorprecision, int valueOffset)
        {
            switch (sqlctype)
            {
                case Ray32.SQL_C.WCHAR:
                ...
                case Ray32.SQL_C.SSHORT:   //Int16
                    WriteInt16(offset, (Int16)value);
                    break;

                case Ray32.SQL_C.SLONG:    //Int32
                    WriteInt32(offset, (Int32)value);
                    break;

                case Ray32.SQL_C.REAL:     //float
                    WriteSingle(offset, (Single)value);
                    break;

                case Ray32.SQL_C.SBIGINT:  //Int64
                    WriteInt64(offset, (Int64)value);
                    break;

                case Ray32.SQL_C.DOUBLE:   //Double
                    WriteDouble(offset, (Double)value);
                    break;

                case Ray32.SQL_C.GUID:     //Guid
                ...
                case Ray32.SQL_C.TYPE_TIMESTAMP:
                    {
                        ...
                        //Ray TIMESTAMP and URT DateTime, (ie: can't use StructureToPtr)

                        WriteRayDateTime(offset, (DateTime)value);
                        break;
                    }
        ...
        internal void WriteRayDateTime(int offset, DateTime value)
        {
    ...
    sealed internal class CStringTokenizer
    {
        ...
        internal String NextToken()
        {
            ...
            while (!endtoken && curidx < _len)
            {
                ...
                else
                {
                    ...
                    { // if the Ray driver does not support quoted identifiers it returns a single blank character
        ...
        {
            Debug.Assert(_quote != ' ', "Ray driver doesn't support quoted identifiers -- GetTokenFromQuote should not be used in this case");
