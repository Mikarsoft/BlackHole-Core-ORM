...
namespace BlackHole.Ray
{
    ...
    public sealed class RayCommand : DbCommand, ICloneable
    {
        ...
        private RayTransaction _transaction;

        private WeakReference weakDataReaderReference;

        private CMDWrapper _cmdWrapper;

        private RayParameterCollection _parameterCollection;   // Parameter collection

        private ConnectionState cmdState;

        public RayCommand() : base()
        {
            GC.SuppressFinalize(this);
        }

        public RayCommand(string cmdText) : this()
        {
        ...
        public RayCommand(string cmdText, RayConnection connection) : this()
        {
            CommandText = cmdText;
            Connection = connection;
        }

        public RayCommand(string cmdText, RayConnection connection, RayTransaction transaction) : this()
        {
            CommandText = cmdText;
            Connection = connection;
        ...
        private void DisposeDeadDataReader()
        {
            if (ConnectionState.Fetching == cmdState)
            {
                if (null != this.weakDataReaderReference && !this.weakDataReaderReference.IsAlive)
                {
                    if (_cmdWrapper != null)
                    {
                        _cmdWrapper.FreeKeyInfoStatementHandle(Ray32.STMT.CLOSE);
                        _cmdWrapper.FreeStatementHandle(Ray32.STMT.CLOSE);
                    }
                    CloseFromDataReader();
                }
            }
        ...
        internal void DisconnectFromDataReaderAndConnection()
        {
            ...
            RayDataReader liveReader = null;
            if (this.weakDataReaderReference != null)
            {
                RayDataReader reader;
                reader = (RayDataReader)this.weakDataReaderReference.Target;
        ...
        Editor("Microsoft.VSDesigner.Data.Ray.Design.RayCommandTextEditor, " + AssemblyRef.MicrosoftVSDesigner, "System.Drawing.Design.UITypeEditor, " + AssemblyRef.SystemDrawing)
        ]
        override public string CommandText
        {
            ...
            set
            {
                if (Bid.TraceOn)
                {
                    Bid.Trace("<Ray.RayCommand.set_CommandText|API> %d#, '", ObjectID);
        ...
        { // V1.2.3300, XXXCommand V1.0.5000
            ...
            set
            {
                Bid.Trace("<Ray.RayCommand.set_CommandTimeout|API> %d#, %d\n", ObjectID, value);
                if (value < 0)
                {
            ...
            set
            {
                ...
                { // @perfnote: Enum.IsDefined
                    ...
                    case CommandType.TableDirect:
                        throw Ray.NotSupportedCommandType(value);
                    default:
        ...
        { // V1.2.3300
            ...
            set
            {
                Connection = (RayConnection)value;
            }
        }
        ...
        { // V1.2.3300
            ...
            set
            {
                Transaction = (RayTransaction)value;
            }
        }
        ...
        new public RayParameterCollection Parameters
        {
            get
            {
                if (null == _parameterCollection)
                {
                    _parameterCollection = new RayParameterCollection();
                }
        ...
        new public RayTransaction Transaction
        {
            get
            {
        ...
        internal RayDescriptorHandle GetDescriptorHandle(Ray32.SQL_ATTR attribute)
        {
        ...
        internal CMDWrapper GetStatementHandle()
        {
            ...
            if (_cmdWrapper == null)
            {
                ...
                _connection.AddWeakReference(this, RayReferenceCollection.CommandTag);
            }
            ...
            {
                _cmdWrapper.FreeStatementHandle(Ray32.STMT.RESET_PARAMS);
            }
            return _cmdWrapper;
        }
        ...
        override public void Cancel()
        {
            ...
            if (null != wrapper)
            {
                ...
                RayStatementHandle stmt = wrapper.StatementHandle;
                if (null != stmt)
                {
                    lock (stmt)
                    {
                        // Cancel the statement
                        Ray32.RetCode retcode = stmt.Cancel();
        ...
        {
            RayCommand clone = new RayCommand();
            Bid.Trace("<Ray.RayCommand.Clone|API> %d#, clone=%d#\n", ObjectID, clone.ObjectID);
            ...
            {
                RayParameterCollection parameters = clone.Parameters;
        ...
        new public RayParameter CreateParameter()
        {
        ...
        override public int ExecuteNonQuery()
        {
            ...
            using (RayDataReader reader = ExecuteReaderObject(0, ADP.ExecuteNonQuery, false))
            {
                reader.Close();
        ...
        new public RayDataReader ExecuteReader()
        {
            return ExecuteReader(0/*CommandBehavior*/);
        }


        new public RayDataReader ExecuteReader(CommandBehavior behavior)
        {
            RayConnection.ExecutePermission.Demand();
            return ExecuteReaderObject(behavior, ADP.ExecuteReader, true);
        }

        internal RayDataReader ExecuteReaderFromSQLMethod(object[] methodArguments,
        Ray32.SQL_API method)
        {
        ...
        private RayDataReader ExecuteReaderObject(CommandBehavior behavior, string method, bool needReader)
        { // MDAC 68324
            ...
            return ExecuteReaderObject(behavior, method, needReader, null, Ray32.SQL_API.SQLEXECDIRECT);
        }

        private RayDataReader ExecuteReaderObject(CommandBehavior behavior,
                                                   string method,
                                                   bool needReader,
                                                   object[] methodArguments,
                                                   Ray32.SQL_API RayApiMethod)
        { // MDAC 68324

            RayDataReader localReader = null;
            try
            {
                ...
                RayStatementHandle stmt = GetStatementHandle().StatementHandle;
                ...
                if (null != weakDataReaderReference)
                {
                    if (weakDataReaderReference.IsAlive)
                    {
                        ...
                        {
                            if (!((RayDataReader)target).IsClosed)
                            {
                ...
                localReader = new RayDataReader(this, _cmdWrapper, behavior);
                    ...
                    if (Connection.IsV3Driver)
                    {
                        if (!Connection.ProviderInfo.NoSqlSoptSSNoBrowseTable && !Connection.ProviderInfo.NoSqlSoptSSHiddenColumns)
                        {
                            ...
                            if (localReader.IsBehavior(CommandBehavior.KeyInfo))
                            {
                                ...
                                {
                                    TrySetStatementAttribute(stmt, (Ray32.SQL_ATTR)Ray32.SQL_SOPT_SS.NOBROWSETABLE, (IntPtr)Ray32.SQL_NB.ON);
                                    TrySetStatementAttribute(stmt, (Ray32.SQL_ATTR)Ray32.SQL_SOPT_SS.HIDDEN_COLUMNS, (IntPtr)Ray32.SQL_HC.ON);
                            ...
                            else
                            {
                                ...
                                {
                                    TrySetStatementAttribute(stmt, (Ray32.SQL_ATTR)Ray32.SQL_SOPT_SS.NOBROWSETABLE, (IntPtr)Ray32.SQL_NB.OFF);
                                    TrySetStatementAttribute(stmt, (Ray32.SQL_ATTR)Ray32.SQL_SOPT_SS.HIDDEN_COLUMNS, (IntPtr)Ray32.SQL_HC.OFF);
                ...
                try
                {
                    ...
                    if (!localReader.IsBehavior(CommandBehavior.SchemaOnly))
                    {
                            ...
                            && (CommandType != CommandType.StoredProcedure))
                        {
                            ...
                            else if (retcode == Ray32.RetCode.NO_DATA)
                            {
                                // do nothing
                            }
                            else
                        ...
                        switch (RayApiMethod)
                        {
                            case Ray32.SQL_API.SQLEXECDIRECT:
                            ...
                            case Ray32.SQL_API.SQLPROCEDURES:
                            ...
                            case Ray32.SQL_API.SQLPROCEDURECOLUMNS:
                            ...
                            case Ray32.SQL_API.SQLSTATISTICS:
        ...
        override public void Prepare()
        {
            ...
            RayStatementHandle stmt = _cmdWrapper.StatementHandle;
        ...
        void TrySetStatementAttribute(RayStatementHandle stmt, Ray32.SQL_ATTR stmtAttribute, IntPtr value)
        {

            Ray32.RetCode retcode = stmt.SetStatementAttribute(
                stmtAttribute,
                value,
                Ray32.SQL_IS.UINTEGER);
        ...
        private void ValidateOpenConnection(string methodName)
        {
            ...
            RayConnection connection = Connection;
    ...
    sealed internal class CMDWrapper
    {
        ...
        private RayStatementHandle _keyinfostmt;           // hStmt for keyinfo
        ...
        internal CMDWrapper(RayConnection connection)
        {
        ...
        internal RayStatementHandle KeyInfoStatement
        {
            get
            {
                return _keyinfostmt;
        ...
        {
            RayDescriptorHandle handle = _hdesc;
            if (null != handle)
            {
                _hdesc = null;
                handle.Dispose();
        ...
        internal void DisposeStatementHandle()
        {
            ...
            RayStatementHandle handle = _stmt;
            if (null != handle)
            {
                _stmt = null;
                handle.Dispose();
        ...
        {
            RayStatementHandle handle = _keyinfostmt;
            if (null != handle)
            {
                _keyinfostmt = null;
                handle.Dispose();
        ...
        internal void FreeStatementHandle(Ray32.STMT stmt)
        {
            DisposeDescriptorHandle();
        ...
        internal void FreeKeyInfoStatementHandle(Ray32.STMT stmt)
        {
            RayStatementHandle handle = _keyinfostmt;
            if (null != handle)
            {
        ...
        internal RayDescriptorHandle GetDescriptorHandle(Ray32.SQL_ATTR attribute)
        {
            RayDescriptorHandle hdesc = _hdesc;
            if (null == _hdesc)
            {
                _hdesc = hdesc = new RayDescriptorHandle(_stmt, attribute);
            }
            return hdesc;
        }
        ...
        internal void StatementErrorHandler(Ray32.RetCode retcode)
        {
            switch (retcode)
            {
                case Ray32.RetCode.SUCCESS:
        ...
        internal void UnbindStmtColumns()
        {
            if (_hasBoundColumns)
            {
                FreeStatementHandle(Ray32.STMT.UNBIND);
