...
internal static partial class Bid
    {
        ...
        {
            if ((modFlags & ActivityCorrelator.CorrelationTracePoints) != 0
        ...
        internal static void TraceSqlReturn(
            string fmtPrintfW,
            [BidArgumentType(typeof(Int32))] Ray32.RetCode a1)
        {
            if (((Ray32.RetCode.SUCCESS != a1) || (modFlags & ApiGroup.StatusOk) != 0) && (modFlags & ApiGroup.Trace) != 0 && modID != NoData)
