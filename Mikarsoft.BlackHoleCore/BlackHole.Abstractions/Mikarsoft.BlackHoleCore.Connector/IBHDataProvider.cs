...
namespace Mikarsoft.BlackHoleCore.Connector
{
    public interface IBHDataProvider
    {
        ...
        bool JustExecute(string commandText, List<BlackHoleInnerParameter>? parameters = null);
        ...
        T? QueryFirst<T>(string commandText, List<BlackHoleInnerParameter>? parameters = null);
